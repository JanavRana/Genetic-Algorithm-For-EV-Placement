...
def main() -> None:
    ...
    # 1. User input of no of stations 
    ...
    # 5. Converting chromosome to station coordinates 
    print("\nMapping stations to coordinates symbol(📍)", end=" ", flush=True)
    ...
    # 6. Build map 
    print("\nBuilding interactive map", end=" ", flush=True)
    m = build_map(
        bbox=bbox,
        density=density,
